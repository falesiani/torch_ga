...
def main():
    ...
    _run_parameterized("torchga-gpu", "mul-mv-mv", "test_torchga.py::test_torchga_mul_mv_mv[%d]", num_elements)
    _run_parameterized("torchga", "mul-mv-mv", "test_torchga.py::test_torchga_mul_mv_mv[%d]", num_elements, env=cpu_env)
    ...
    _run_parameterized("torchga-gpu", "add-mv-mv", "test_torchga.py::test_torchga_add_mv_mv[%d]", num_elements)
    _run_parameterized("torchga", "add-mv-mv", "test_torchga.py::test_torchga_add_mv_mv[%d]", num_elements, env=cpu_env)
